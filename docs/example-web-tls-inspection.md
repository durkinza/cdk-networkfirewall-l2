...
export class WebFirewallTlsInspectionStack extends cdk.Stack {
  constructor(
    scope: cdk.App,
    id: string,
    props: WebFirewallTlsInspectionStackProps,
  ) {
    ...
    const tlsInspection = new NetFW.TLSInspectionConfiguration(
      this,
      "TlsInspection",
      {
    ...
    const domainAllowList = new NetFW.StatefulDomainListRuleGroup(
      this,
      "DomainAllowList",
      {
